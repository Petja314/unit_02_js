...
let e1 = '3';
let f1 = 5;
document.querySelector('.out-4').textContent = e1 + f1; //разница в том что '3' это не число а строка поэтому идет строка + число
...
let e2 = 3;
let f2 = 0;
document.querySelector('.out-5').textContent = e2 / f2; //делимое на 0 = бесконечность
...
let e4 = 3;
let f4 = 'Hello';
document.querySelector('.out-7').textContent = e4 * f4; //строка на число не умножаеться = NaN
...
function t9() {
    let viewdata = document.querySelector('.i-9').value;
    document.querySelector('.out-9').innerHTML = viewdata;
    inputIn.value = '';
}
...
function t10() {
    let datasearch = document.querySelector('.i-10').value;
    document.querySelector('.out-10').innerHTML = datasearch * 20;
}
...
function t11() {
    let lookinner = document.querySelector('.i-11').value;
    document.querySelector('.out-11').innerHTML = lookinner + '55';
}
...
let aOne = document.querySelector('.i-13-1');
let bOne = document.querySelector('.i-13-2');
...
function t14() {
    let changes = document.querySelector('.i-14').value = 'Go';
}
...
function t15() {
    let changestyle = document.querySelector('.i-15').style.border = "4px solid red";
}
...
function t16() {
    let summaryfirst = document.querySelector('.i-16-1').value;
    let summarysecond = document.querySelector('.i-16-2').value;
    document.querySelector('.out-16').innerHTML = Number(summaryfirst) + Number(summarysecond);
}
...
// let aTwo = document.querySelector('.i-19-1');
// let bTwo = document.querySelector('.i-19-2');
...
function t20() {
    ...
    console.log('out-20'); // Можно посмотреть
}
